...
let arrowSum = (num1, num2, num3, num4) => num1 + num2 + num3 + num4;

// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Here is old school sum:', sum(1, 2, 3, 4));
console.log('Here is arrowSum', arrowSum(1, 2, 3, 4));
...
console.log('Arrow Function', arrowObjectLit());
